...
import seederData from "./subtasks.seeder.json";
...
const SubtasksSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SubtasksSeederDialogComponent);
