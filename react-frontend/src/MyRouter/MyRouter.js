...
import SingleSubtasksPage from "../components/app_components/SubtasksPage/SingleSubtasksPage";
import SubtaskProjectLayoutPage from "../components/app_components/SubtasksPage/SubtaskProjectLayoutPage";
import SingleTimelogsPage from "../components/app_components/TimelogsPage/SingleTimelogsPage";
import TimelogProjectLayoutPage from "../components/app_components/TimelogsPage/TimelogProjectLayoutPage";
...
<Route path="/subtasks/:singleSubtasksId" exact element={<SingleSubtasksPage />} />
<Route path="/subtasks" exact element={<SubtaskProjectLayoutPage />} />
<Route path="/timelogs/:singleTimelogsId" exact element={<SingleTimelogsPage />} />
<Route path="/timelogs" exact element={<TimelogProjectLayoutPage />} />
