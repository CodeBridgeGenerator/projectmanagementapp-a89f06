...
import seederData from "./timelogs.seeder.json";
...
const TimelogsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TimelogsSeederDialogComponent);
