...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.clientID}</p>
...
const pTemplate5 = (rowData, { rowIndex }) => <p >{rowData.status}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="clientID" header="Client ID" body={pTemplate0} filter={selectedFilterFields.includes("clientID")} hidden={selectedHideFields?.includes("clientID")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="startDate" header="Start Date" body={pTemplate3} filter={selectedFilterFields.includes("startDate")} hidden={selectedHideFields?.includes("startDate")}  sortable style={{ minWidth: "8rem" }} />
<Column field="endDate" header="End Date" body={pTemplate4} filter={selectedFilterFields.includes("endDate")} hidden={selectedHideFields?.includes("endDate")}  sortable style={{ minWidth: "8rem" }} />
