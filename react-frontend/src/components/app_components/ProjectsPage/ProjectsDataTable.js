...
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.clientID}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.projectTitle}</p>
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.description}</p>
const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.startDate}</p>
const pTemplate5 = (rowData, { rowIndex }) => <p >{rowData.endDate}</p>
...
<Column field="clientID" header="Client ID" body={pTemplate1} filter={selectedFilterFields.includes("clientID")} hidden={selectedHideFields?.includes("clientID")}  sortable style={{ minWidth: "8rem" }} />
<Column field="projectTitle" header="Project Title" body={pTemplate2} filter={selectedFilterFields.includes("projectTitle")} hidden={selectedHideFields?.includes("projectTitle")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="startDate" header="Start Date" body={pTemplate4} filter={selectedFilterFields.includes("startDate")} hidden={selectedHideFields?.includes("startDate")}  sortable style={{ minWidth: "8rem" }} />
<Column field="endDate" header="End Date" body={pTemplate5} filter={selectedFilterFields.includes("endDate")} hidden={selectedHideFields?.includes("endDate")}  sortable style={{ minWidth: "8rem" }} />
