...
hoursSpent: _entity?.hoursSpent,
logDate: _entity?.logDate,
description: _entity?.description,
        ...
        const result = await client.service("timelogs").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info timelogs updated successfully" });
    ...
    return (
        <Dialog header="Edit Timelogs" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="timelogs-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="hoursSpent" className="w-full mb-3 p-inputtext-sm" value={_entity?.hoursSpent} onChange={(e) => setValByKey("hoursSpent", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
